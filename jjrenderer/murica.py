...
class RendererMuricaClock(Renderer):
  name = "clock_murica"
  isclock = True
  menuitem = {"icon":"icon_murica.png","text":"'Murica","description":"Like Clockwork. Date = number of gun deaths so far this year, Time = number of gun deaths so far today, in US Customary fractions. Plus eagles. U.S.A. U.S.A."}
  updateinterval = 5
